...
HD_PWD='E:/Xilinx_project/HDL_projects_for_digital_circuit_course/Learning/ALU/ALU.runs/testdata_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testdata_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testdata_mem.tcl
