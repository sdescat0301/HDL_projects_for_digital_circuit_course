...
HD_PWD='E:/Xilinx_project/Learning/decoder/decoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Segment_Displays.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Segment_Displays.tcl -notrace
