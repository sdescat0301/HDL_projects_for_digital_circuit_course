...
#
# Generated by Vivado on Fri Jul 09 14:27:08 +0800 2021
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dmem xil_defaultlib.dmem xil_defaultlib.glbl -log elaborate.log
}
